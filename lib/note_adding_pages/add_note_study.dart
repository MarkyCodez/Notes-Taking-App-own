...
import 'package:todo_app_01/note_getting_pages/view_note_study.dart';

class AddNoteStudy extends StatefulWidget {
  ...
  @override
  State<AddNoteStudy> createState() => _AddNotePageState();
}

class _AddNotePageState extends State<AddNoteStudy> {
  final TextEditingController _titleController = TextEditingController();

  final TextEditingController _noteController = TextEditingController();

  late Box<dynamic> _study;
