...
import 'package:todo_app_01/note_getting_pages/view_note_work.dart';

class AddNoteWork extends StatefulWidget {
  ...
  @override
  State<AddNoteWork> createState() => _AddNotePageState();
}

class _AddNotePageState extends State<AddNoteWork> {
  final TextEditingController _titleController = TextEditingController();

  final TextEditingController _noteController = TextEditingController();

  late Box<dynamic> _work;
